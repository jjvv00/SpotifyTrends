...
>>>>>>> 82fd24c (Added captions to missing value plots)
=======
Even Oppenheimer completed a project called “Using Data to Find the Angriest Death Grips Song“ [(Oppenheimer, 2022)](https://medium.com/@evanopp/angriest-death-grips-data-anger-502168c1c2f0). We plan to follow this procedure in tandem with the valence and energy variables from the “spotifyr” R wrapper to analyze the moods of the songs. Our current concern is that Oppenheimer uses an r package, ‘genius,’ written by Josiah Parry with ‘tidytext” by Julia Slige to count the number of angry words that are in songs. “genuis” package allows easy access to lyrics as text data, however, Parry announced on October 31, 2021, that he will not be maintaining the package due to the gray legal area [(Parry, 2023)](https://github.com/JosiahParry/genius) . On the other hand, “tidytext” was recently updated on September 5, 2023 [(Silge, 2023)](https://github.com/juliasilge/tidytext)  
>>>>>>> 7d99a2c (fixing hyperlinks in data chapter)
